...
-- Contexto del Uso de BEGIN y END

-- Cuando creas una función o procedimiento almacenado, necesitas agrupar las instrucciones que definen la 
-- lógica de la función o el procedimiento. Aquí es donde BEGIN y END juegan un papel importante.

-- Detalle del Uso de BEGIN y END

-- BEGIN: Marca el inicio de un bloque de código. Todo el código entre BEGIN y END se ejecuta como un bloque.

-- END: Marca el final del bloque de código iniciado por BEGIN.
-- Dentro de este bloque, puedes incluir cualquier número de instrucciones SQL, declaraciones de control de flujo (IF, WHILE, LOOP, etc.),
-- y llamadas a otras funciones o procedimientos.



-- Funcion para calcular el precio del promedio de todos los productos
delimiter //
